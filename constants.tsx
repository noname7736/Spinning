...
export const PRODUCTION_NODES: NetworkNode[] = [
  ...
  { id: 'db-rel', name: 'POSTGRES_RDS', ip: '10.0.5.1', type: 'database', status: NodeStatus.IMMUTABLE, layer: 'DATA_FABRIC', osi: 7, integrity: 100, provider: 'AWS', dbType: 'RELATIONAL' },
  { id: 'db-vec', name: 'WEAVIATE_VECTOR', ip: '10.0.5.2', type: 'database', status: NodeStatus.SOVEREIGN, layer: 'DATA_FABRIC', osi: 7, integrity: 100, provider: 'OPEN_SOURCE', dbType: 'VECTOR' },
  { id: 'db-graph', name: 'NEO4J_GRAPH', ip: '10.0.5.3', type: 'database', status: NodeStatus.HEALING, layer: 'DATA_FABRIC', osi: 7, integrity: 99.9, provider: 'GCP', dbType: 'GRAPH' },
  { id: 'db-doc', name: 'COSMOS_DOCUMENT', ip: '10.0.5.4', type: 'database', status: NodeStatus.IMMUTABLE, layer: 'DATA_FABRIC', osi: 7, integrity: 100, provider: 'AZURE', dbType: 'DOCUMENT' },
  
  // Deployment & Core
  { id: 'ci-cd', name: 'GITHUB_ACTIONS_RUNNER', ip: '172.16.0.10', type: 'server', status: NodeStatus.ENFORCING, layer: 'DEPLOYMENT', osi: 7, integrity: 100 },
  { id: 'k8s-master', name: 'K8S_MASTER_NODE', ip: '10.10.1.1', type: 'server', status: NodeStatus.SOVEREIGN, layer: 'CORE', osi: 7, integrity: 100 },
